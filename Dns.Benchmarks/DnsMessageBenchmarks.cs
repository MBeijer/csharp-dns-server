...
public class DnsMessageBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _queryMessage.Questions.Add(new("www.example.com", ResourceType.A, ResourceClass.IN));
        ...
        _responseMessage.Questions.Add(new("www.example.com", ResourceType.A, ResourceClass.IN));
